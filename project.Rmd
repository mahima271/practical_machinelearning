...
Based on a dataset provide by HAR [http://groupware.les.inf.puc-rio.br/har](http://groupware.les.inf.puc-rio.br/har) try to train a predictive model to predict what exercise was performed using a dataset with 159 features

Steps:

- Process the data, for use of the project
- Explore the data,  the two paramaters we are interested in 
...
Dimensions & head of the dataset
```{r}
# Res 1
dim(training.raw)
